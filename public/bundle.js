		...
		_createClass(Search, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_SearchList2.default, { tours: this.state.tours })
				);
			}
		}]);
		...
		_createClass(SearchBar, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"form",
						{ "class": "searchForm", onSubmit: true },
						_react2.default.createElement("input", { "class": "searchLocation", placeholder: "Put Location", onChange: this.handleInputChange.bind(this) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchListEntry = __webpack_require__(219);

	var _SearchListEntry2 = _interopRequireDefault(_SearchListEntry);

	var _underscore = __webpack_require__(220);
	...
	var SearchList = function (_React$Component) {
		...
		function SearchList(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(SearchList).call(this, props));
		}
			...
			value: function render() {
				return _react2.default.createElement(
					...
					this.props.tours.map(function (tour) {
						return _react2.default.createElement(_SearchListEntry2.default, { tour: tour });
					})
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchListEntry = function (_React$Component) {
		_inherits(SearchListEntry, _React$Component);

		function SearchListEntry(props) {
			_classCallCheck(this, SearchListEntry);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(SearchListEntry).call(this, props));
		}

		_createClass(SearchListEntry, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
	...
	exports.default = SearchListEntry;
